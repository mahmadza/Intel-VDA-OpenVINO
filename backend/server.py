...
class VideoService(vda_pb2_grpc.VideoServiceServicer):
    ...
    def ProcessVideo(self, request, context):
        ...
        # 1. Stream the incremental progress
        ...
        # 2. IMPORTANT: Send the final results so Rust can save them to SQLite
        # Note: You may need to add a 'get_last_results' method to your Orchestrator
        segments = [
